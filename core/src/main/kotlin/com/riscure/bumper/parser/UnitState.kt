...
interface UnitState<Exp,Stmt,Self:UnitState<Exp,Stmt,Self>>: Closeable {
    ...
    /**
     * Get the type environment generated by the translation unit.
     */
    val typeEnv: TypeEnv
    // note: this is part of this API, because it generally depends on the used toolchain.
